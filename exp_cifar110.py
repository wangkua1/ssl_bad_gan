...
class Trainer(object):
    ...
    def __init__(self, config, args):
        ...
        setattr(self.config, 'save_dir', 'cifar110_log')
        ...
        self.labeled_loader, self.unlabeled_loader, self.unlabeled_loader2, self.dev_loader, self.special_set, self.contrast_loader = data.get_cifar110_loaders(config)
    ...
    def _train(self, labeled=None, vis=False):
        ...
        gen_images, _ = self.contrast_loader.next()
        gen_images = Variable(gen_images.cuda())
